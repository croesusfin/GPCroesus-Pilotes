...
Le tout se déroulera sur 2 étapes, une pré-course (enregistrement de votre courreur) et la course (remplie
d'opportunités)!

La voiture avec le plus de tours complétés à la fin de l'épreuve sera déclarée gagnante.

Choisissez votre courreur, enregistrez vous, la course débutera dans 30 minutes!
...
## Étape 2: Choisir la lambda utilisée par cotre courreur (son kart)
...
## Étape 3: Enregistrer votre courreur au directeur de course

Maintenant que vous avez trouvé l’URL du directeur de course et choisi votre cheval de bataille, il est temps
d’enregistrer votre courreur et son kart pour pouvoir participer à la course!

Roulez une **tâche ECS*** qui fera l'enregistrement de votre courreur auprès du directeur de course.
...
- **DRIVER_NAME**: Nom de votre courreur. Respectez la thématique! (Attention, premier arrivé premier servi!)
...
Le courreur est enregistré et la course n'est pas commencée? Super, vous pouvez déjà penser aux challenges!
...
Bloque le prochain tour du courreur derrière vous
...
Bloque le prochain tour des 3 courreurs derrière vous
...
Bloque le prochain tour du courreur devant vous
...
Bloque le prochain tour des 3 courreurs devant vous
...
À une chance sur 2 de bloquer le prochain tour du courreur devant vous
...
À une chance sur 3 de bloquer le prochain tour des 3 courreurs devant vous
...
Bloque les 5 prochains tours du courreur en tête!
...
Vous fait faire 3 tours au lieu d'un seul ET bloque le prochain tour de TOUS les autres courreurs!
